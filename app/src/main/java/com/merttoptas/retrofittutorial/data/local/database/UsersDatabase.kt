...
//        fun getUsersDatabase(context: Context) : UsersDatabase = instance ?: synchronized(this) {
//            instance ?: buildDatabase(context).also { instance = it }
//        }

        private fun buildDatabase(context: Context) {
            Room.databaseBuilder(context, UsersDatabase::class.java, Constants.DATABASE_USERS_NAME)
